# Cimarrón Analytics - Arquitectura en la Nube y BI 📊

Este proyecto migra un conjunto de datos normalizado del INEGI hacia una arquitectura en la nube, consumiéndolo a través de una API RESTful y visualizándolo en Power BI para la toma de decisiones.
...
* Mapa interactivo validando calidad de datos geográficos (coordenadas limpias).
